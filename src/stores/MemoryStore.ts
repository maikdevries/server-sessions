...
export class MemoryStore implements Store {
	...
	/**
	 * Removes the session associated with the given key from the store.
	 *
	...
	/**
	 * Retrieves the session associated with the given key from the store.
	 */
	...
	/**
	 * Stores a session associated with the given key in the store.
	 *
	 * This will overwrite any existing session stored previously at the given key.
	 */
